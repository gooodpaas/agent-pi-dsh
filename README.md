...
<p align="center">
  ...
  <a href="https://github.com/deepseek-ai/deepseek-harness/releases/tag/dsh-v0.1.6-alpha.1"><img src="https://img.shields.io/badge/source-DSH%20dsh--v0.1.6--alpha.1-2f6df0?style=flat-square" alt="DSH dsh-v0.1.6-alpha.1"></a>
  <a href="https://www.agent-pi.app/docs.html"><img src="https://img.shields.io/badge/文档-Docs-0fb5c9?style=flat-square" alt="Docs"></a>
</p>

<p align="center">
  <a href="https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.6.7/Agent-Pi-DSH-3.6.7-x64.exe"><b>Windows x64</b></a>
  ·
  <a href="https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.6.7/Agent-Pi-DSH-3.6.7-mac-arm64.dmg"><b>macOS arm64</b></a>
  ·
  <a href="https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.6.7/Agent-Pi-DSH-3.6.7-linux-x86_64.AppImage"><b>Linux AppImage</b></a>
  ·
...
| 平台 | 文件 |
| --- | --- |
| Windows x64 | [Agent-Pi-DSH-3.6.7-x64.exe](https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.6.7/Agent-Pi-DSH-3.6.7-x64.exe) |
| macOS Apple Silicon | [Agent-Pi-DSH-3.6.7-mac-arm64.dmg](https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.6.7/Agent-Pi-DSH-3.6.7-mac-arm64.dmg) · [zip](https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.6.7/Agent-Pi-DSH-3.6.7-mac-arm64.zip) |
| Linux x64 | [AppImage](https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.6.7/Agent-Pi-DSH-3.6.7-linux-x86_64.AppImage) · [deb](https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.6.7/Agent-Pi-DSH-3.6.7-linux-amd64.deb) |
| 2.6.5 经典版 | [可与 3.x 并存](https://github.com/xiangxin2021cn/agent-pi/releases/tag/v2.6.5) |

国内镜像（Windows）：[gh-proxy.com](https://gh-proxy.com/https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.6.7/Agent-Pi-DSH-3.6.7-x64.exe) · [ghfast.top](https://ghfast.top/https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.6.7/Agent-Pi-DSH-3.6.7-x64.exe)
...
| 版本 | 一句话 |
| --- | --- |
| [3.6.7](./release/github-notes-3.6.7.md) | DSH rc.2；主动开启官方 Agent Teams；启动恢复与依赖验证 |
| [3.6.5](./release/github-notes-3.6.5.md) | DSH rc.1；官方 V4.1 Flash 原生图片能力；保留资源文件栏 |
| [3.6.3](./release/github-notes-3.6.3.md) | DSH alpha.1；灰度模型原生图片能力；保留完整 Office 插件 |
| [3.6.1](./release/github-notes-3.6.1.md) | DSH 0.1.5-alpha.1；Office 0.2.13 新服务路径；DWG 完整本地预览与取景、性能收敛 |
...
<p align="center">
  ...
  · Always π AI Studio
  · development kernel: dsh-v0.1.6-alpha.1
</p>
